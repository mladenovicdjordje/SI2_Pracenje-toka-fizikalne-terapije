...
?>
    <section class="blok-plan">
        ...
        <p>
            ...
            · <?= htmlspecialchars(['nacrt'=>'Nacrt','aktivan'=>'Aktivan','zavrsen'=>'Završen','prekinut'=>'Prekinut'][$red->status()] ?? $red->status()) ?>
        </p>
        ...
        <table>
            ...
            <?php foreach ($vezbe as $v): ?>
                <tr>
                    <td><?= htmlspecialchars((string) $v['naziv']) ?></td>
                    <td><?= htmlspecialchars((string) $v['deo_tela']) ?></td>
                    <td><?= (int) $v['serije'] ?></td>
                    <td><?= (int) $v['ponavljanja'] ?></td>
                    <td><?= htmlspecialchars((string) ($v['opis'] ?? '')) ?></td>
                </tr>
            <?php endforeach; ?>
            </tbody>
        </table>
